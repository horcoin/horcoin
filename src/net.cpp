...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("horizoncoin-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "HorizonCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seed1.horizoncoin.eu", "seed1.horizoncoin.eu"},
    {"seed2.horizoncoin.eu", "seed2.horizoncoin.eu"},
    {"seed3.horizoncoin.eu", "seed3.horizoncoin.eu"},
    {"seed4.horizoncoin.eu", "seed4.horizoncoin.eu"},
    {"seed5.horizoncoin.eu", "seed5.horizoncoin.eu"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("horizoncoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("horizoncoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("horizoncoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("horizoncoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. HorizonCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("horizoncoin-start");
